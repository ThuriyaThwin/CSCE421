...
public class PIntensionConstraint extends PConstraint {
	...
	public String toString() {
		String output = super.toString() + ". Type: Intension \n    Function/predicate defined : "+ function.getName() + function;
		//super.toString() + ", and associated function/predicate " + function.getName() + " and universal expression = " + Toolkit.buildStringFromTokens(universalPostfixExpression)
		return output;
	}
